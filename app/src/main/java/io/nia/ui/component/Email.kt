...
import io.nia.Email
import io.nia.EmailRepositoryImpl
        ...
        Column {
            Row {
                ...
                Text(
                    ...
                    style = MaterialTheme.typography.bodySmall, modifier = Modifier.alpha(0.5f),
                )
            }
...
fun EmailItemPreview() {
    NiaTheme {
        EmailItem(email = EmailRepositoryImpl.DEMO)
    }
}
...
fun EmailDetailPreview() {
    NiaTheme {
        EmailDetail(email = EmailRepositoryImpl.DEMO)
    }
}